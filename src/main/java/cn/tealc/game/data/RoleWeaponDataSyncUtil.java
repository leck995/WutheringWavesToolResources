 ...
 * @description: 同步https://ww.nanoka.cc/,用于角色id与各语言名字获取，下载图像。
 * @author: Leck
 * @create: 2024-10-22 16:41
 */
public class RoleWeaponDataSyncUtil {
    ...
    public static RoleBaseData create(String id,JsonNode roleNode) {
        ...
        names.put(Locale.SIMPLIFIED_CHINESE, roleNode.get("zh").asText());
        ...
        String s = temp.replace("/Game/Aki/UI","");
